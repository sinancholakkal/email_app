...
class TrashScreen extends StatefulWidget {
  ...
  @override
  State<TrashScreen> createState() => _SendEmailScreenState();
}

class _SendEmailScreenState extends State<TrashScreen> {
  late ScrollController _controller;
  bool isLoading = false;
  List<Email> datas = [];
  @override
  void initState() {
    context.read<TrashBloc>().add(LoadTrashDataEvent());
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: () async {
            context.read<TrashBloc>().add(RefreshTrashDataEvent());
          },
