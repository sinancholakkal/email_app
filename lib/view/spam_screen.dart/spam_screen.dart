...
class SpamScreen extends StatefulWidget {
  ...
  @override
  State<SpamScreen> createState() => _SendEmailScreenState();
}

class _SendEmailScreenState extends State<SpamScreen> {
  late ScrollController _controller;
  bool isLoading = false;
  List<Email> datas = [];
  @override
  void initState() {
    context.read<SpamBloc>().add(LoadSpamDataEvent());
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      appBar: AppBar(
        ...
        actions: [
          BlocBuilder<SpamBloc, SpamState>(
